...
### Under Review
- Cheng, Z., Xu, H., **Sha, T.**, Zhao, Y., Li, M., Dong, Y. *TRIDENT: An Efficient Data-Free Model Extraction Attack for Graph Neural Networks.* **ICLR 2026 (under review).**
- Chen, Z., **Sha, T.**, Chen, Y., Xu, B., Zheng, Y., Cheng, Z., Liu, J., Wang, K. *DIAL-G^2: Graph-Guided Dialectical Agent for Advanced ESG Reasoning.* **AAAI 2026 (under review).**
